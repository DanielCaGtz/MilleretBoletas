		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="callout callout-info">
					...
					<h4>Aquí puedes editar los aspectos a evaluar para cada asignatura</h4>
					Selecciona la materia que quieras editar. Puedes arrastrar cada aspecto en el orden que quieras, así como agregar o eliminar nuevos.
				</div>
				<div class="row">
