					...
					<div class="box bg-blue box-solid">
						...
						<form role="form" class="form-contact formulario" id="main_form" style="background: #eaeaea;color: black;">
							...
							<div class="box-body">
								...
								<div class="form-group parent_data_container" data-type="multiple"><?php $x=1; ?>
									<div class="checkbox"><label><input type="checkbox" value="1" class="campo_editable" data-name="rincon_<?php echo $x++; ?>">Lectura</label></div>
									<div class="checkbox"><label><input type="checkbox" value="1" class="campo_editable" data-name="rincon_<?php echo $x++; ?>">Ortografía</label></div>
									<div class="checkbox"><label><input type="checkbox" value="1" class="campo_editable" data-name="rincon_<?php echo $x++; ?>">Caligrafía</label></div>
									<div class="checkbox"><label><input type="checkbox" value="1" class="campo_editable" data-name="rincon_<?php echo $x++; ?>">Razonamiento lógico</label></div>
								</div>
							</div>
							<div class="box-body">
								<div class="form-group">
