				...
				<div class="col-lg-8 col-xs-8">
					<div class="box bg-blue box-solid">
						...
						<form role="form" class="form-contact formulario" id="main_form" style="background: #eaeaea;color: black;">
							...
							<div class="box-body">
								<div class="form-group">
									<?php $d="text_field_".$xx++; ?><label for="field_<?php echo $d; ?>">Rincones / Estaciones de trabajo</label>
									<p><?php echo $data_plan[$d]; ?></p>
								</div>
							</div>
							<div class="box-body">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<textarea data-field="<?php echo $d; ?>" class="campo_editable_main form-control" data-id="<?php echo $id; ?>" id="<?php echo $d; ?>" required><?php echo $data_plan[$d]; ?></textarea>
								</div>
							</div>
